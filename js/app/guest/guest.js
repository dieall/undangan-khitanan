...
export const guest = (() => {
    ...
    const buildGoogleCalendar = () => {
        ...
        const data = new URLSearchParams({
            action: 'TEMPLATE',
            text: 'Tasyakuran Khitanan Sabiq Uzair Qhariz Wijaya',
            dates: `${formatDate('2026-05-30 10:00')}/${formatDate('2026-05-30 11:00')}`,
            details: 'Tanpa mengurangi rasa hormat, kami mengundang Anda untuk berkenan menghadiri acara tasyakuran khitanan kami. Terima kasih atas perhatian dan doa restu Anda, yang menjadi kebahagiaan serta kehormatan besar bagi kami.',
